package io.dimasla4ee.shoppinglist.feature.products_screen.ui.dialog
...
import shoppinglist.composeapp.generated.resources.dialog_delete_all_items
import shoppinglist.composeapp.generated.resources.ic_warning_24

@Composable
fun DeleteAllProductsDialog(
    onDismiss: () -> Unit,
    onConfirm: () -> Unit
) {
    AlertDialog(
        ...
        title = {
            Column(
                ...
                Text(
                    text = stringResource(Res.string.dialog_delete_all_items),
